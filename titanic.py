...
print(df['Parch'])
print(df['Age'])
corrected_values = df['Age'].fillna(method='ffill', inplace=True)
...
surviving_childen = children.loc[df['Survived'] == 1]
print(surviving_childen)
print('The number of children who survived were', surviving_childen.notnull().sum())
print('Therefore the percentage of children who survived were', (83/173)*100)
print('The percentage of people who are above 18 that survived is', (100-47.98))
...
matrix = np.corrcoef(df['Age'], df['Survived'])
print(matrix)
